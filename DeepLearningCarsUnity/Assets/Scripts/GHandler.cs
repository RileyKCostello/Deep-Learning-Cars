...
public class GHandler : MonoBehaviour
{
    ...
    [Header("Options")]
    public static bool childrenAreAveraged;
    public static bool randomChildren;
    public static int numMutantMutations;
    public static int numChildMutations;
    [Header("Car ratios")]
    public int numCars;
    public static int numFrontRunners;
     ...
     * Increase the range of weights and biases, when mutating they will be moved up or down by 0.05 to 1 instead of randomized
     * Add hidden layers or increase size
     */
     ...
     * Customize number and size of layers in neural network
     */
